...
(function() {
  ...
  module.exports = JadePages = (function() {
    ...
    function JadePages(config) {
      var filter, fn, htmlminConfig, jadeConfig, optimize, pluginConfig, _base, _ref, _ref1, _ref2;
      ...
      if (optimize) {
        if ((_base = this.jadeOptions).pretty == null) {
          _base.pretty = false;
        }
      }
      if ((pluginConfig != null ? pluginConfig.filters : void 0) != null) {
        _ref2 = pluginConfig.filters;
        for (filter in _ref2) {
          fn = _ref2[filter];
